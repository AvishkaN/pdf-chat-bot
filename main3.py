...
import chromadb
from langchain.llms import GooglePalm  # Import the correct LLM class from LangChain
...
def get_vector_store(text_chunks):
    ...
    #     collection.add(embedding_id=f"chunk_{idx}", embedding=embedding, metadata={"text": chunk})
...
def get_conversational_chain():
    ...
    # Use LangChain's native LLM wrapper for the model you're using
    model = GooglePalm(temperature=0.3, model_name="gemini-1.5-flash")
